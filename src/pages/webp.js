...
function WEBP() {
  ...
  const [toConvert, setToConvert] = useState("webp");
  ...
  const onConvertClick = () => {
    ...
    ConvrtFunction('webp', form).then((result) => {
      console.log(result);
      if (result.status) {
        setLoader(false);
          ...
          <div className="bg-gray-200 rounded mt-3">
            <div className="grid md:grid-cols-4 gap-4 p-3 flex items-center">
              ...
              <div className="flex  justify-center">
                ...
                >
                  <option value="webp">WEBBP</option>
                </select>
              </div>
              <div className="flex justify-center">
